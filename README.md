...
Small forms management application built with Next.js 16 (App Router).
...
-   Repository pattern for data access (FormRepository)
-   Service layer for business logic (FormService)
